...
<div class="max-w-[85rem] mt-12 mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20  ">
    <div>
      <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight ">Daftar Keangotaan Di <span class="text-blue-600">SistemPT</span></h1>
      <p class="mt-3 text-lg text-gray-800">Keangotaan Individu & Keangotaan Perguruan Tinggi</p>

      <!-- Buttons -->
      <div class="mt-7 grid gap-3 w-full sm:inline-flex">
        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="{{ route('individu') }}">
          Daftar Keangotaan
