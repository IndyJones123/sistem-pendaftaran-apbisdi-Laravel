...
<head>
    ...
    {{-- ... --}}
    <script type="module" src="{{ asset('build/assets/app-B8hU5Egv.js') }}"></script>
...
<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto ">
  ...
  <div class="text-center">
    ...
    <div class="mt-3">
      <p class="text-gray-500">We're part of the <a class="font-semibold text-blue-600 hover:text-blue-700" href="#">UPN Veteran</a> Jawa Timur.</p>
      <p class="text-gray-500">© Sistem PT. {{$currentYear}}. All rights reserved.</p>
    </div>
