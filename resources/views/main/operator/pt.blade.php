        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          ...
          <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200">
            <div>
             ...
             <!-- Search Form -->
            <form action="{{ route('operator/pt') }}" method="GET" class="sm:col-span-1">
            ...
            <tbody class="divide-y divide-gray-200">
              ...
              <tr class="bg-white hover:bg-gray-50">
                      ...
                      <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden divide-y divide-gray-200 min-w-40 z-20 bg-white shadow-2xl rounded-lg p-2 mt-2" aria-labelledby="hs-table-dropdown-1">
                        <div class="py-2 first:pt-0 last:pb-0">
                          ...
                          @if($data->status == 'pending')
                            ...
                            <a class="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500" href="{{ route('status.disapprove.pt', $data->id) }}">
                              Disapprove
                            </a>
                              ...
                              <form action="{{ route('status.approve.pt', $data->id) }}" method="POST">
                                ...
                                <div class="mb-4">
                                  ...
                                  <input type="text" required id="link" name="link" class="mt-1 block w-full text-sm border-gray-300 rounded-lg focus:border-blue-500 focus:ring-blue-500">
                                                                ...
                                                                <div class="mb-4">
                                  <label for="sertifikat_file" class="block text-sm font-medium text-gray-700">Link Invoice</label>
                ...
                <div id="edit-modal-{{ $data->id }}" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50 hidden">
                            <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full relative">
                              <!-- Close Button -->
                              <h2 class="text-lg font-semibold mb-4">Upload Link Gdrive</h2>
                              <form action="{{ route('status.edit.pt', $data->id_user) }}" method="POST">
                                @csrf
                                <div class="mb-4">
                                  <label for="sertifikat_file" class="block text-sm font-medium text-gray-700">Edit Link Sertifikat</label>
                                  <input type="text" value="{{$data->id_user}}" required id="link" name="link" class="mt-1 block w-full text-sm border-gray-300 rounded-lg focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                                                <div class="mb-4">
                                  <label for="sertifikat_file" class="block text-sm font-medium text-gray-700">Edit Link Invoice</label>
                                  <input type="text" required id="link2" name="link2" class="mt-1 block w-full text-sm border-gray-300 rounded-lg focus:border-blue-500 focus:ring-blue-500">
                                </div>
                                <div class="mt-4 flex gap-x-4">
