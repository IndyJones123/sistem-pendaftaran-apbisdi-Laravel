    ...
    <div class="mt-5 sm:mt-10 lg:mt-0 lg:col-span-5">
      <div class="space-y-6 sm:space-y-8">
        ...
        <div class="space-y-2 md:space-y-4">
          <h2 class="font-bold text-3xl lg:text-4xl text-gray-500 dark:text-neutral-500">
            Akun Anda Telah Terverifikasi Oleh Pihak Operator
          </h2>
          <p class="text-gray-500 dark:text-neutral-500">
            Silahkan Download Sertifikat Anda Di Menu Sertifikat
          </p>
        </div>
        <!-- End Title -->
        ...
        <ul class="space-y-2 sm:space-y-4">
          <li class="flex space-x-3">
            ...
            <span class="text-sm sm:text-base text-gray-500 dark:text-neutral-500">
              <span class="font-bold">Membuat Akun</span> – Dosen
            </span>
          </li>
          ...
          <li class="flex space-x-3">
            ...
            <span class="text-sm sm:text-base text-gray-500 dark:text-neutral-500">
              <span class="font-bold">Akun Diverifikasi</span> –  Operator
            </span>
          </li>
          ...
          <li class="flex space-x-3">
            ...
            <span class="text-sm sm:text-base text-gray-500 dark:text-neutral-500">
              <span class="font-bold">Download Sertifikat</span> –  Dosen
            </span>
          </li>
        </ul>
        <!-- End List -->
...
<!-- End Features -->
    @elseif ($individuData->status == 'ditolak' || $individuData->status == 'nonaktive')
    ...
    <div class="grid md:grid-cols-2 items-center gap-12">
        <div>
        <h1 class="text-3xl font-bold sm:text-4xl lg:text-5xl lg:leading-tight">
            Perbarui Berkas PT
        </h1>
        ...
        <div class="mt-8">
            ...
            <li class="flex space-x-3">
                <svg class="flex-shrink-0 mt-0.5 size-5 text-gray-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                <span class="text-gray-600">
                Mengisi Kembali Form Disamping
                </span>
            </li>
            ...
            <li class="flex space-x-3">
                <svg class="flex-shrink-0 mt-0.5 size-5 text-gray-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                <span class="text-gray-600">
                Anda Bisa Mengakses Layanan Setelah Data Anda Diverifikasi Operator dan Disetujui
                </span>
            </li>
            </ul>
        </div>
        ...
        <div class="mt-10 flex items-center gap-x-5">
            ...
            <img class="inline-block size-8 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Image Description">
            <img class="inline-block size-8 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1531927557220-a9e23c1e4794?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2.5&w=320&h=320&q=80" alt="Image Description">
            <img class="inline-block size-8 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1541101767792-f9b2b1c4f127?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=3&w=320&h=320&q=80" alt="Image Description">
            ...
            Sudah 101 Orang Menjadi Anggota
            </span>
        </div>
        </div>
        <!-- End Col -->
        ...
        <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-10">
            ...
            Form Pendaftaran PT (Perguruan Tinggi)
            </h2>
            ...
            <div class="mt-6 grid gap-4 lg:gap-6">
                ...
                <div>
                    <label for="namapengelola" class="block mb-2 text-sm text-gray-700 font-medium ">Nama Pengelola PT</label>
                    <input type="text" name="namapengelola" id="namapengelola" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>

                <div>
                    <label for="nidn" class="block mb-2 text-sm text-gray-700 font-medium ">NIDN</label>
                    <input type="number" name="nidn" id="nidn" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
                </div>
                <!-- End Grid -->
                            <!-- Grid -->
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                    <label for="namakaprodi" class="block mb-2 text-sm text-gray-700 font-medium ">Nama Kepala Prodi</label>
                    <input type="text" name="namakaprodi" id="namakaprodi" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>

                <div>
                    <label for="alamat" class="block mb-2 text-sm text-gray-700 font-medium ">Alamat PT</label>
                    <input type="text" name="alamat" id="alamat" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
                </div>
                <!-- End Grid -->
                <div>
                <label for="email" class="block mb-2 text-sm text-gray-700 font-medium ">Email</label>
                <input readonly type="email" value="{{ Auth::user()->email }}" name="email" id="email"  class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
                <div>
                <label for="namapt" class="block mb-2 text-sm text-gray-700 font-medium ">Nama PT</label>
                <input type="text" name="namapt" id="namapt"  class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
                <!-- Grid -->
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                    <label for="telp" class="block mb-2 text-sm text-gray-700 font-medium ">No Telpon</label>
                    <input type="text" name="telp" id="telp" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>

                <div>
                <label for="kodept" class="block mb-2 text-sm text-gray-700 font-medium ">Kode PT</label>
                <input type="text" name="kodept" id="kodept" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
                </div>
                <!-- End Grid -->

                <div>
                    <label for="berkas1" class="block mb-2 text-sm text-gray-700 font-medium">Berkas 1</label>
                    <input type="text" id="berkas1" name="berkas1" class="py-3 px-4 block w-full border-black-500 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                <div> 
                    <label for="berkas2" class="block mb-2 text-sm text-gray-700 font-medium">Berkas 2</label>
                    <input type="text" id="berkas2" name="berkas2" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
                <div>
                    <label for="berkas3" class="block mb-2 text-sm text-gray-700 font-medium">Berkas 3</label>
                    <input type="text" id="berkas3" name="berkas3" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
            </div>

            <!-- //Hidden Input Default -->
            <input type="number" name="id_biaya" id="id_biaya" value="1" hidden>
            <input type="number" name="id_user" id="id_user" value="{{ Auth::user()->id }}" hidden>
            <input type="date" name="tgldaftar" id="tgldaftar" value="{{ $currentDate }}" hidden>
            ...
            Verifikasi Akun Anda Memakan Waktu 1 - 2 Hari Kerja.
            </p>
            </div>
        </div>
        <!-- End Card -->
...
@if(!$individuData)
<h1>Selamat Datang Akun Anda Masih Belum Terdaftar Mohon Lengkapi Formulir Dibawah Ini</h1>
  ...
  <div class="grid md:grid-cols-2 items-center gap-12">
    <div>
      ...
      <p class="mt-1 md:text-lg ">
        Portal Registrasi Keangotaan Dosen
      </p>
      ...
      <div class="mt-8">
        ...
        <ul class="mt-2 space-y-2">
          ...
          <li class="flex space-x-3">
            <svg class="flex-shrink-0 mt-0.5 size-5 text-gray-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
            <span class="text-gray-600">
              Anda Bisa Mengakses Layanan Setelah Data Anda Diverifikasi Operator
            </span>
          </li>
        </ul>
      </div>
    ...
    <div class="relative">
      ...
      <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-10">
        <h2 class="text-xl font-semibold ">
          Form Pendaftaran Keangotaan Dosen
        </h2>

        <form action="{{ route('individu.store') }}" method="POST">
        @csrf
        <div class="mt-6 grid gap-4 lg:gap-6">
            <!-- Grid -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                    <label for="namadosen" class="block mb-2 text-sm text-gray-700 font-medium">Nama Dosen</label>
                    <input type="text" name="namadosen" id="namadosen" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>

                <div>
                    <label for="id_pt" class="block mb-2 text-sm text-gray-700 font-medium">Nama PT</label>
                    <select name="id_pt" id="id_pt" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                    <label for="notelp" class="block mb-2 text-sm text-gray-700 font-medium">No Telpon</label>
                    <input type="number" name="notelp" id="notelp" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
                </div>
            ...
            <div>
                <label for="nidn" class="block mb-2 text-sm text-gray-700 font-medium">NIDN</label>
                <input type="number" id="nidn" name="nidn" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
                <label for="dokumen1" class="block mb-2 text-sm text-gray-700 font-medium">Dokumen 1</label>
                <input type="text" id="dokumen1" name="dokumen1" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div> 
                <label for="dokumen2" class="block mb-2 text-sm text-gray-700 font-medium">Dokumen 2</label>
                <input type="text" id="dokumen2" name="dokumen2" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
                <label for="dokumen3" class="block mb-2 text-sm text-gray-700 font-medium">Dokumen 3</label>
                <input type="text" id="dokumen3" name="dokumen3" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
        </div>

        <!-- Hidden Input Default -->
        <input type="number" name="id_biaya" id="id_biaya" value="0" hidden>
        <input type="number" name="id_user" id="id_user" value="{{ Auth::user()->id }}" hidden>
        <input type="text" name="status" id="status" value="pending" hidden>
