...
@if ($individuData)
  ...
  <p class="mt-12 text-center mx-auto" >Data Saya Salah Saya Ingin Memperbaruinya <a href="{{route('user/editprofile')}}" class="text-blue-500">Click Here</a></p>
  <!-- End Grid -->
</div>
...
<!-- End Features -->
    @elseif ($individuData->status == 'ditolak' || $individuData->status == 'nonactive')
    
    <div class="max-w-[85rem] mx-auto  px-4 sm:px-6 lg:px-8">
  <!-- Grid -->
  <div class="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
    <div class="lg:col-span-3">
      <h1 class="block text-2xl font-bold text-red-400 sm:text-4xl md:text-5xl lg:text-4xl">Akun Anda Ditolak / Non Aktif</h1>
      <p class="mt-3 text-lg text-gray-800">Mohon Memperbarui Data Diri Anda  <a href="{{route('user/editprofile')}}" class="text-blue-500">Click Here</a></p>
