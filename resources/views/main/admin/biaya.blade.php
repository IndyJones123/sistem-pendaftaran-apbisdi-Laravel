          ...
          <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200">
            <div>
              <h2 class="text-xl font-semibold text-gray-800">
                Daftar Harga Pendaftaran Keangotaan
              </h2>
              <p class="text-sm text-gray-600">
                Ubah Harga Pendaftaran Disini
              </p>
            </div>
          </div>
          <!-- End Header -->
              ...
              <tr class="bg-white hover:bg-gray-50">
                <td class="size-px whitespace-nowrap">
                  <a class="block relative z-10" href="#">
                    <div class="px-6 py-2">
                      <div class="block text-sm text-blue-600 decoration-2 hover:underline">{{$biaya->keterangan}}</div>
                    </div>
                  </a>
                </td>
                ...
                <a class="block relative z-10" href="#">
                    <div class="px-6 py-2">
                    <p class="text-sm text-gray-500">{{ number_format($biaya->biaya, 0, ',', '.') }} IDR</p>
                    </div>
                </a>
                </td>
                <td class="h-px w-20 min-w-20 max-w-xs">
                <a href="{{ route('biayaedit', $biaya->id) }}" class="block relative z-10">
                    <div class="px-6 py-2">
