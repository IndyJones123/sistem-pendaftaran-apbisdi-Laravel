        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          ...
          <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200">
            <div>
              <h2 class="text-xl font-semibold text-gray-800">
                List Akun sertifikat Sistem Informasi
              </h2>
              <p class="text-sm text-gray-600">
                Aktif dan Nonaktifkan Akun sertifikat Sistem Informasi
              </p>
            </div>
             <!-- Input -->
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
              @foreach($sertifikatIndividuData as $sertifikat)
              <tr class="bg-white hover:bg-gray-50">
                <td class="size-px whitespace-nowrap">
                  <a class="block relative z-10" href="#">
                    <div class="px-6 py-2">
                      <div class="block text-sm text-blue-600 decoration-2 hover:underline">{{$sertifikat->id_individu}}</div>
                    </div>
                  </a>
                </td>
                ...
                <a class="block relative z-10" href="#">
                    <div class="px-6 py-2">
                    <p class="text-sm text-gray-500">{{$sertifikat->tglmulai}}</p>
                    </div>
                </a>
                </td>
                ...
                <td class="size-px h-px w-20 min-w-20 whitespace-nowrap">
                        <div class="px-6 py-2">
                        @if ($sertifikat->tglberakhir < $currentDate)
                        <a class="block relative z-10  opacity-50 text-blue-500 hover:text-blue-700 " href="#">
                          Active
                        </a>
                        @else
                        <a class="block relative z-10  opacity-50 text-red-500 hover:text-red-700 " href="#">
                          NonActive
                        </a>
                        @endif
                        </div>  
